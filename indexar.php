...
Entrada: f= forum number; t= que buscar (1:(COM) - 2: (PED)); l= (letra)  [l es un parámetro opcional]
...
// Parsing de los parámetros recibidos
...
// Parsing especial para parámetro l
...
if ($handle = fopen($archivo, "w")){
 exit("Error groso al abrir el archivo: " . $archivo);
}
else {
 exit($archivo . " no es escribible, fijate los permisos.");
}

// Encabezado javascript
...
// Imprimimos las películas y sus links
$cantPelis = 0;
$cantPelisNew = 0;
$cantPelisMod = 0;
$ultimaLetra = "";
